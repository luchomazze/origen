    ...
    >
      ...
      <div className="p-5">
        {listing.tipo_propiedad && (
          <div style={{ fontFamily: "'Montserrat'", fontSize: '8px', letterSpacing: '0.2em', textTransform: 'uppercase', color: '#B88E3A', fontWeight: 600, marginBottom: '6px' }}>
            {tipoLabel[listing.tipo_propiedad] ?? listing.tipo_propiedad}
          </div>
        )}
        <div style={{ fontFamily: "'Playfair Display', Georgia, serif", fontSize: '17px', fontWeight: 600, color: '#0D1B2A', marginBottom: '4px', lineHeight: 1.2 }}>
          {listing.titulo}
        </div>
        {locationLabel && (
