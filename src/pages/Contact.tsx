...
export default function Contact({ navigate: _, waConfig }: NavProps) {
  const waUrl = buildWAUrl(waConfig, 'propertyMsg', 'Consulta general')
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
          <div>
            ...
            <h2 style={{ fontFamily: "'Playfair Display', Georgia, serif", fontSize: '28px', fontWeight: 600, color: '#0D1B2A', marginBottom: '20px', lineHeight: 1.25 }}>
              Nuestro objetivo es acompañarte.
            </h2>
            ...
            <p style={{ fontFamily: "'Montserrat'", fontSize: '14px', color: '#5C636B', lineHeight: 1.85, marginBottom: '36px' }}>
              Nuestro objetivo es acompañarte con información, conocimiento y una mirada clara sobre cada oportunidad. Trabajamos principalmente en Córdoba Sur, la zona de mayor crecimiento de la ciudad.
            </p>

            {/* Values */}
            <div className="grid grid-cols-2 gap-4">
              {[
                { title: 'Profesionalismo', desc: 'Asesoramiento comprometido en cada etapa.' },
                { title: 'Transparencia', desc: 'Información clara para decisiones confiadas.' },
                { title: 'Confianza', desc: 'Construida operación a operación.' },
                { title: 'Claridad', desc: 'Sin tecnicismos. Directo al punto.' },
              ].map(v => (
          ...
          <div>
            ...
            <div className="flex flex-col gap-5 mb-10">
              <div style={{ borderBottom: '1px solid rgba(13,27,42,0.08)', paddingBottom: '20px' }}>
                <div style={{ fontFamily: "'Montserrat'", fontSize: '9px', letterSpacing: '0.18em', textTransform: 'uppercase', color: '#5C636B', marginBottom: '6px' }}>WhatsApp</div>
                <a
                  href={waUrl}
                  target="_blank"
              ...
              <div style={{ borderBottom: '1px solid rgba(13,27,42,0.08)', paddingBottom: '20px' }}>
                <div style={{ fontFamily: "'Montserrat'", fontSize: '9px', letterSpacing: '0.18em', textTransform: 'uppercase', color: '#5C636B', marginBottom: '6px' }}>Instagram</div>
                <a
